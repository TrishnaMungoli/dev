...
public class RecordScreen extends ScreenRecorder {
	...
	public static RecordScreen screenRecorder;
	public String name;
	...
	public static void startRecording(String methodName,String path) throws Exception {
		File file = new File(System.getProperty("user.dir")+"//"+path +"//"+createFolder());
